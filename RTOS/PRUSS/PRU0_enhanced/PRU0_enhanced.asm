...
DELAY1:
        ...
        QBNE    DELAY1, r1, 0     ; do the 2-instruction delay loop thing until r1=0

	SET     r30, r30.t5         ; set (turn off) the blue LED
	SET     r30, r30.t7         ; set (turn off) the blue LED
	LBBO    &r1, r0, 0, 4       ; load r1 with 32-bit word stored at SM_ba, offset 0

DELAY2:
        SUB     r1, r1, 1           ; count down the delay
        QBNE    DELAY2, r1, 0     ; do the 2-instruction delay loop thing until r1=0
...
DELAY3:
        SUB     r1, r1, 1           ; count down the delay
        QBNE    DELAY3, r1, 0     ; do the 2-instruction delay loop thing until r1=0
...
DELAY4:
        SUB     r1, r1, 1           ; count down the delay
        QBNE    DELAY4, r1, 0     ; do the 2-instruction delay loop thing until r1=0
...
DELAY5:
        SUB     r1, r1, 1           ; count down the delay     
        QBNE    DELAY5, r1, 0      ; do the 2-instruction delay loop thing until r1=0
...
DELAY6:
        SUB     r1, r1, 1           ; count down the delay
        QBNE    DELAY6, r1, 0     ; do the 2-instruction delay loop thing until r1=0
...
DELAY7:
        SUB     r1, r1, 1           ; count down the delay
        QBNE    DELAY7, r1, 0     ; do the 2-instruction delay loop thing until r1=0
...
DELAY8:
        SUB     r1, r1, 1           ; count down the delay
        QBNE    DELAY8, r1, 0     ; do the 2-instruction delay loop thing until r1=0
