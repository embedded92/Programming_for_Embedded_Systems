...
BUTTON_CHK:
        ...
        CLR     r1, r1.t0      ; ignore other button state
        LSR     r1, r1, 1      ; place Button 1 state in bit 0 of r1
        MOV  	r3, r31.w0      ; load button status of Button 2
        CLR     r3, r3.t1      ; ignore other button state
        LSR     r3, r3, 1      ; place Button 2 state in bit 0 of r3
